...
import RevenueChatsYear from "@/app/components/admin/dasboard/RevenueChartYear";
import OrderStatusPieChart from "@/app/components/admin/dasboard/OrderStatusPieChart";
import RevenueChartDayInMonth from "@/app/components/admin/dasboard/RevenueChartDay";
import StatsCard from "@/app/components/admin/dasboard/StatsCard";
...
const AdminDashboardPage = () => {
  ...
  console.log("orderStatusChartData", orderStatusChartData);
  return (
