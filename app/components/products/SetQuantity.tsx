    ...
    return (
        ...
        <div className="flex items-center gap-4">
            ...
            <div className="flex items-center text-center text-base">
                ...
                />
                <button
                    disabled={selectedProduct.buyQuantity === 99 || selectedProduct.buyQuantity === selectedProduct.selectedVariation.quantity}
                    className={
                        selectedProduct.buyQuantity === 99 ? btnStyles + ' opacity-50' : btnStyles
                    }
