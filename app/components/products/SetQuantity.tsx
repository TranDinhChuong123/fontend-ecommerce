...
import { StockVariationType } from "@/app/[slug]/ProductDetails";
    ...
    return (
        ...
        <div className="flex items-center gap-4">
            ...
            <div className="flex items-center text-center text-base">
                ...
                <button
                    disabled={selectedProduct?.buyQuantity === quantity}
                    className={
                        selectedProduct?.buyQuantity === quantity ? btnStyles + ' opacity-50' : btnStyles
                    }
                    onClick={handleIncrease}>+</button>
            </div>
        </div >
